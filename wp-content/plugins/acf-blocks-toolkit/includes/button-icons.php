...
function acfbt_get_icons( bool $from_file = true ): array {
	...
	$icons = [
		...
		'comment-author-avatar' => [
			'label' => __( 'Comment Author Avatar', 'acf-blocks-toolkit' ),
		...
		'lock-outline'          => [
			'label' => __( 'Lock Outline', 'acf-blocks-toolkit' ),
...
function acfbt_generate_json(): void {
	...
	if ( file_exists( $path ) && $checksum === get_transient( ACFBT_ICONS_CHECKSUM ) ) {
		return;
	}
